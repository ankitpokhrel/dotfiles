...
plugins=(1password brew docker git golang)
...
alias jo="jira open"
alias jb='jira issue list -q "sprint is empty and issuetype not in (Epic, Sub-task)" --order-by rank -s~Done --reverse' # Jira Backlog
